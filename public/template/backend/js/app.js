...
var App = function () {
    ...
    var handleSidebarMenu = function () {
    	jQuery('.page-sidebar li > a').each(function(index) {
			var url = jQuery(this).attr('href');
			var currentUrl = window.location.pathname;
			
			if(currentUrl == url) {
				var parentLv3 = jQuery(this).parent();
				var parentLv2 = jQuery(this).parent().parent();
				var parentLv1 = jQuery(this).parent().parent().parent();
				jQuery(parentLv3).addClass('active');
				jQuery(parentLv2).show();
				jQuery(parentLv1).addClass('active');
				jQuery('a', parentLv1).append('<span class="selected"></span>');
				jQuery('a .arrow', parentLv1).addClass('open');
    ...
    var menuMobile = function () {
        ...
        jQuery('.navbar-toggle').on('click', function (e) {
        	jQuery('body').append('<div class="bg_menu_mobile" onclick="App.menuMobileClose();"></div>');
        	jQuery('.hor-menu').addClass('open');
        });
    }
    
    // Handles the go to top button at the footer
    var menuMobileClose = function () {
		jQuery('.hor-menu').removeClass('open');
		jQuery('.bg_menu_mobile').remove();
    }
    ...
    // NamNV - Sự kiện khi scroll page
    var handleScrollPage = function () {
		$(window).scroll(function () {
			var topPage = $(window).scrollTop();
			if(topPage > 36) {
				jQuery('.page-full-width .page-control').addClass('fixed')
			} else {
				jQuery('.page-full-width .page-control').removeClass('fixed')
			}
		});
    }
    ...
    return {
        ...
        init: function () {
            ...
            //handleScrollPage(); //Sự kiện khi cuộn trang
        ...
        blockUI: function (el, centerY) {
            ...
            el.block({
                message: '<img src="'+ urlTemplate +'/img/ajax-loading.gif" align="">',
