    ...
    public function getServiceConfig(){
        return array(
            'factories'	=> array(
                ...
                'Admin\Model\CustomerDebtDetailTable' => function ($sm) {
                    $adapter = $sm->get('dbConfig');
                    $tableGateway = new TableGateway(TABLE_CUSTOMER_DEBT_DETAIL, $adapter, null);
                    return new \Admin\Model\CustomerDebtDetailTable($tableGateway);
                },
                'Admin\Model\ContractCodTable' => function ($sm) {
                    $adapter = $sm->get('dbConfig');
                    $tableGateway = new TableGateway(TABLE_CONTRACT_COD, $adapter, null);
                    return new \Admin\Model\ContractCodTable($tableGateway);
                },
                ...
                'Admin\Model\WarehouseVatDetailTable'	=> function ($sm) {
                    $adapter = $sm->get('dbConfig');
                    $tableGateway = new TableGateway(TABLE_WAREHOUSE_VAT_DETAIL, $adapter, null);
                    return new \Admin\Model\WarehouseVatDetailTable($tableGateway);
                },
    ...
    public function getFormElementConfig() {
        return array(
            'factories' => array(
                ...
                'formAdminWarehouseVatDetail' => function($sm) {
                    $myForm	= new \Admin\Form\WarehouseVatDetail($sm);
                    $myForm->setInputFilter(new \Admin\Filter\WarehouseVatDetail());
                    return $myForm;
                },
