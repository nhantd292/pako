...
class History extends Form{
	...
	public function __construct($sm, $params = NULL){
		...
		$this->add(array(
		    ...
		    'options'		=> array(
		        'value_options'	=> array('created' => 'Ngày tạo', 'return' => 'Ngày hẹn chăm sóc lại'),
		    )
		));
		...
		$this->add(array(
		    ...
		    'options'		=> array(
		        'empty_option'	=> '- Hành động -',
		        'value_options'	=> \ZendX\Functions\CreateArray::create($sm->get('Admin\Model\DocumentTable')->listItem(array( "table" => "document", "where" => array( "code" => "sale-history-action" )), array('task' => 'cache')), array('key' => 'id', 'value' => 'name')),
		    )
		));
		...
		$this->add(array(
		    ...
		    'options'		=> array(
		        'empty_option'	=> '- Kết quả -',
		        'value_options'	=> \ZendX\Functions\CreateArray::create($sm->get('Admin\Model\DocumentTable')->listItem(array( "table" => "document", "where" => array( "code" => "sale-history-result" )), array('task' => 'cache')), array('key' => 'id', 'value' => 'name')),
		    )
		));
