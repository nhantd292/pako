...
class ProductsPrice extends Form
{
    ...
    public function __construct($sm, $params)
    {
        ...
        $this->add(array(
            'name' => 'filter_trademark',
            'type' => 'Select',
            'attributes' => array(
                'class' => 'form-control select2 select2_basic',
            ),
            'options' => array(
                'empty_option' => '- Thương hiệu -',
                'value_options' => \ZendX\Functions\CreateArray::create($sm->get('Admin\Model\DocumentTable')->listItem(array('where' => array('code' => 'trademark')), array('task' => 'cache')), array('key' => 'id', 'value' => 'name')),
            )
        ));
        ...
        $this->add(array(
            ...
            'options'		=> array(
                ...
                'value_options'	=> \ZendX\Functions\CreateArray::create($sm->get('Admin\Model\ProductsTypeTable')->listItem(null, array('task' => 'cache')), array('key' => 'id', 'value' => 'name')),
            )
        ));
