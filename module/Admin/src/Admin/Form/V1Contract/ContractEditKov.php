	...
	public function __construct($sm){
        ...
        $this->add(array(
            ...
            'options'		=> array(
                ...
                'value_options'	=> \ZendX\Functions\CreateArray::create($sm->get('Admin\Model\UserTable')->listItem(null, array('task' => 'list-marketing')), array('key' => 'id', 'value' => 'name')),
            ),
        ));
        ...
        // Ghi chú giao hàng tiết kiệm
        $this->add(array(
            'name'			=> 'ghtk_note',
            'type'			=> 'Text',
            'attributes'	=> array(
