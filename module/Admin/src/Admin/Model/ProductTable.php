...
class ProductTable extends DefaultTable {
...
//	    }
        ...
        if($options['task'] == 'list-item') {
            $result	= $this->tableGateway->select(function (Select $select) use ($arrParam, $options){
                ...
                if(isset($ssFilter['filter_tailors_status']) && $ssFilter['filter_tailors_status'] !='') {
                    $select -> where -> equalTo('tailors_status', $ssFilter['filter_tailors_status']);
                }
            })->current();
        }
	...
	public function saveItem($arrParam = null, $options = null){
		...
		if($options['task'] == 'add-item') {
			...
			$data	= array(
				...
				'tailors_status'    => $arrData['tailors_status'],
