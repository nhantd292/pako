...
class WarehouseFundTable extends DefaultTable {
    ...
    public function countItem($arrParam = null, $options = null){
	    if($options['task'] == 'list-item') {
	        $result	= $this->tableGateway->select(function (Select $select) use ($arrParam, $options){
                ...
                if(isset($ssFilter['filter_warehouse_id']) && $ssFilter['filter_warehouse_id'] != '') {
                    $select->where->equalTo('warehouse_id', $ssFilter['filter_warehouse_id']);
                }
                ...
                if(isset($ssFilter['filter_keyword']) && $ssFilter['filter_keyword'] != '') {
                    $select->where->NEST
                        ...
                        ->or
                        ->equalTo('note', $ssFilter['filter_keyword'])
                        ->UNNEST;
                }
            })->count();
	    }
