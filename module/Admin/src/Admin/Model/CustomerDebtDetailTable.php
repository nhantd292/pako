...
class CustomerDebtDetailTable extends DefaultTable {
	...
	public function saveItem($arrParam = null, $options = null){
        ...
        $customer_debt_id = $arrData['customer_debt_id'];
        ...
        if($options['task'] == 'add-item') {
            ...
            try {
                ...
                throw new \Exception('Insert Customer Debt Detail Table failed: ' . $e->getMessage());
            }
        }

        if($options['task'] == 'delete_detail_by_debt_id') {
            $sql_delete = "DELETE FROM ".TABLE_CUSTOMER_DEBT_DETAIL." WHERE ".TABLE_CUSTOMER_DEBT_DETAIL.".customer_debt_id = '".$customer_debt_id."'";
