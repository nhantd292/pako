...
class ContractDebtOldController extends ActionController {
    ...
    public function init() {
        ...
        $this->_params['ssFilter']['filter_debt']       = 'debt_old';
    ...
    public function indexAction() {
        ...
        $this->_viewModel['caption']                = 'đơn hàng công nợ cũ - Danh sách';
