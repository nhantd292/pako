...
class WarehouseController extends ActionController{
    public $caption = 'Kho hàng';
    public function init() {
        // Thiết lập options
        $this->_options['tableName'] = 'Admin\Model\WarehouseTable';
        $this->_options['formName'] = 'formAdminWarehouse';
