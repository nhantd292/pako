...
class TaskCategoryController extends ActionController {
    
    public function init() {
        
        // Thiết lập options
        $this->_options['tableName'] = 'Admin\Model\TaskCategoryTable';
        $this->_options['formName'] = 'formAdminTaskCategory';
    ...
    public function indexAction() {
        $myForm	= new \Admin\Form\Search\TaskCategory($this->getServiceLocator());
        ...
        $this->_viewModel['caption']    = 'Danh mục công việc - Danh sách';
    ...
    public function formAction() {
        ...
        $task = 'add-item';
        $caption = 'Danh mục công việc - Thêm mới';
        $item = array();
        if(!empty($this->params('id'))) {
            ...
            if(!empty($item)) {
                ...
                $myForm->bind($item);
                $task = 'edit-item';
                $caption = 'Danh mục công việc - Sửa';
            }
        }
