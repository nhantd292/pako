...
class ProductsInventoryController extends ActionController{
    public $caption = 'Tồn kho sản phẩm';

    public function init() {
        // Thiết lập options
        $this->_options['tableName'] = 'Admin\Model\ProductsInventoryTable';
        $this->_options['formName'] = 'formAdminProductsInventory';
        ...
        $this->_params['ssFilter']['filter_warehouse']          = $ssFilter->filter_warehouse;
    ...
    public function filterAction() {
        if ($this->getRequest()->isPost()) {
            ...
            $ssFilter->filter_warehouse         = $data['filter_warehouse'];
    ...
    public function indexAction() {
        $myForm    = new \Admin\Form\Search\ProductsInventory($this->getServiceLocator(), $this->_params['ssFilter']);
