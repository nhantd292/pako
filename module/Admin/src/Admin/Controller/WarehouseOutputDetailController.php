...
class WarehouseOutputDetailController extends ActionController {
    
    public function init() {
        // Thiết lập options
        $this->_options['tableName'] = 'Admin\Model\WarehouseOutputDetailTable';
        $this->_options['formName'] = 'formAdminWarehouseOutputDetail';
