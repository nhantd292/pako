...
class ProductListedController extends ActionController {
    ...
    public function indexAction() {
        ...
        $this->_params['ssFilter']['filter_type'] = 'price';
        ...
        $this->_viewModel['caption']                = 'Niêm yết sản phẩm - Danh sách';
    ...
    public function addAction() {
        ...
        $this->_viewModel['caption']    = 'Giá niêm yết - Thêm mới';
        return new ViewModel($this->_viewModel);
    }
    ...
    public function editAction() {
        ...
        $this->_viewModel['myForm']         = $myForm;
        $this->_viewModel['product_type']   = $this->getServiceLocator()->get('Admin\Model\DocumentTable')->listItem(array('where' => array('code' => 'product-type')), array('task' => 'cache'));
        $this->_viewModel['caption']        = 'Sửa định mức sản phẩm';
    ...
    public function importAction()
    {
        ...
        $this->_viewModel['caption'] = 'Import niêm yết sản phẩm';
        $this->_viewModel['myForm']  = $myForm;
        $viewModel                   = new ViewModel($this->_viewModel);
        ...
        if ($this->getRequest()->isXmlHttpRequest()) {          
            if ($this->getRequest()->isPost()) {
                ...
                $itemFlooring       = $this->getServiceLocator()->get('Admin\Model\DocumentTable')->getItem(array('name' => $this->_params['data']['flooring'], 'code' => 'flooring'), array('task' => 'by-custom-name'));
                ...
                if (!empty($productListed)) {
                    ...
                    $contact = $this->getServiceLocator()->get('Admin\Model\ProductListedTable')->saveItem($data, array('task' => 'import-insert'));
                    echo 'Hoàn thành';
                }
