...
class CampaignController extends ActionController {
    ...
    public function indexAction() {
        ...
        $myForm	= new \Admin\Form\Search\Form($this->getServiceLocator());
        ...
        $this->_viewModel['caption']    = 'Chiến dịch - Danh sách';
    ...
    public function formAction() {
        ...
        if(!empty($this->params('id'))) {
            ...
            if(!empty($item)) {
                $myForm->setInputFilter(new \Admin\Filter\Campaign(array('id' => $this->_params['data']['id'])));
                $myForm->bind($item);
                $task = 'edit-item';
                $caption = 'Chiến dịch - Sửa';
            }
        }
        
        if($this->_params['route']['code'] == 'copy') {
            $caption = 'Chiến dịch - Copy';
            $task = 'add-item';
            $this->_params['data']['id'] = '';
        }
