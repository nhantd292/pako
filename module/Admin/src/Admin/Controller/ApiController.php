...
//        $this->postJson(file_get_contents('php://input'));// Đẩy dữ liệu sang webhook.site để kiểm tra
        ...
        foreach($notifications as $notifi){
            foreach($notifi['Data'] as $item_get){
                ...
                $customer = json_decode($this->kiotviet_call(RETAILER, $this->kiotviet_token, '/customers/'.$item_get['CustomerId']), true);
                ...
                $convert['CustomerPhone']   = $customer['contactNumber'];
                ...
                $convert['CreatedDate']     = $this->convertToDateTime($item_get['CreatedDate']);
