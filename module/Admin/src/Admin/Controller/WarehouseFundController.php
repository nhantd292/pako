...
class WarehouseFundController extends ActionController{
    public $caption = 'Sổ quỹ';
    public function init() {
        // Thiết lập options
        $this->_options['tableName'] = 'Admin\Model\WarehouseFundTable';
        $this->_options['formName'] = 'formAdminWarehouseFund';
