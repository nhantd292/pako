...
class ShowInfoListener implements ListenerAggregateInterface{
	...
	public function attach(EventManagerInterface $events){
		...
		$this->listeners[] 	= $shareEventManager->attach('ZendX\Event\Foo','showInfo', array($this, 'funcDoOne'));
		$this->listeners[] 	= $shareEventManager->attach('ZendX\Event\Foo','showInfo', array($this, 'funcDoTwo'));
	}
